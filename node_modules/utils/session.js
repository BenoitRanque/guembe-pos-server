...
async function authenticateEmployee ({ EmployeeID, Password }) {
  const { data: employee } = await sap.get(`/EmployeesInfo(${EmployeeID})`, {
    params: {
      '$expand': `SalesPerson`,
      '$select': `EmployeeID,Active,U_GMBPOS_Password,SalesPerson/SalesEmployeeCode,SalesPerson/SalesEmployeeName,SalesPerson/Active`
    }
  })
